          ...
          <li key={book.id} className="group/book relative flex-none">
            <Link
              ...
              onFocus={(event) => {
                ...
                animateBook(event.currentTarget, true);
              }}
            ...
            >
              ...
              <span
                data-book-spine
                className="absolute inset-0 overflow-hidden rounded-[4px] brightness-[0.84] saturate-[0.78] will-change-[filter,transform]"
              ...
              >
                {book.coverUrl ? (
                  ...
                  <span className="absolute inset-0 flex items-center justify-center px-1 py-3 text-[10px] font-semibold tracking-[0.04em] text-white/85 [writing-mode:vertical-rl]">
                    {book.title}
                  </span>
                )}
